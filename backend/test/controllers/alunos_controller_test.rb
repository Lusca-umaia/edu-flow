...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { matricula: @aluno.matricula, turma_id_id: @aluno.turma_id_id, user_id_id: @aluno.user_id_id } }, as: :json
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { matricula: @aluno.matricula, turma_id_id: @aluno.turma_id_id, user_id_id: @aluno.user_id_id } }, as: :json
    assert_response :success
  end
