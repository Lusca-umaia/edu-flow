...
import {
  ...
  professorCreateSchema,
  professorCreateFields as fields,
} from "../utils";
import { useFormSubmit } from "@/hooks/useFormSubmit";
import Header from "@/components/UI/Header/Header";
import FormInput from "@/components/FormInput/FormInput";
import { cadastrarProfessor } from "@/services/professor/cadastrarProfessor";

export default function CadastrarProfessor() {
  const { formData, errors, isLoading, handleChange, handleSubmit } =
    useFormSubmit<ProfessorCreateSchema>({
      schema: professorCreateSchema,
      initialData: initialCreateFormData as ProfessorCreateSchema,
